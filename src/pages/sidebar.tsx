        ...
        <div className={`w-full h-full ${isDarkMode ? 'text-white shadow-lg' : 'text-black border border-gray-300'} flex flex-col rounded-2xl`} style={isDarkMode ? { backgroundColor: '#0d0e14' } : { backgroundColor: '#f9f9f8' }}>
          ...
          <nav className="flex-1 p-5 lg:p-2 xl:p-5 order-2 md:order-2">
            <div className="space-y-4">
              ...
              <Link to="/swap" className={`flex items-center lg:justify-center xl:justify-start space-x-3 lg:space-x-0 xl:space-x-3 p-3 rounded-lg transition-colors ${isDarkMode ? 'text-gray-300 hover:text-white hover:bg-gray-800' : 'text-gray-700 hover:text-black hover:bg-gray-100'}`} title="Trade">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
                </svg>
                <span className="lg:hidden xl:block">Trade</span>
              </Link>
